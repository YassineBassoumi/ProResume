                        ...
                        <div className="flex flex-col gap-4 text-center items-center">
                            {status === 'verifying' && (
                                <>
                                    ...
                                    <p className="text-2xl font-black leading-tight tracking-[-0.033em] text-gray-900 dark:text-white">Verifying Email...</p>
                                    <p className="text-base font-normal leading-normal text-gray-500 dark:text-gray-400">Please wait while we verify your email address.</p>
                                </>
                            )}
                            ...
                            {status === 'success' && (
                                <>
                                    ...
                                    <p className="text-2xl font-black leading-tight tracking-[-0.033em] text-gray-900 dark:text-white">Email Verified!</p>
                            ...
                            {status === 'error' && (
                                <>
                                    ...
                                    <p className="text-2xl font-black leading-tight tracking-[-0.033em] text-gray-900 dark:text-white">Verification Failed</p>
