                ...
                <div className="flex w-full flex-col gap-8">
                    ...
                    <div className="flex w-full flex-col gap-8 rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-background-dark/50 md:p-8">
                        <div className="flex flex-col gap-2 text-center">
                            <p className="text-2xl font-black leading-tight tracking-[-0.033em] text-gray-900 dark:text-white md:text-3xl">Reset Password</p>
                            <p className="text-base font-normal leading-normal text-gray-500 dark:text-gray-400">Enter your new password below.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="flex w-full flex-col gap-4">
                            <label className="flex flex-col">
                                <p className="pb-2 text-sm font-medium leading-normal text-gray-900 dark:text-gray-200">New Password</p>
                            ...
                            <label className="flex flex-col">
                                <p className="pb-2 text-sm font-medium leading-normal text-gray-900 dark:text-gray-200">Confirm Password</p>
                                <div className="relative flex w-full items-center">
                                    <span className="material-symbols-outlined absolute left-3 text-lg text-gray-400">lock</span>
                                    <input
                        ...
                        <p className="text-center text-sm text-gray-600 dark:text-gray-300">
                            ...
                            <Link className="font-medium text-primary hover:underline" to="/login">Sign In</Link>
                        </p>
                    </div>
                </div>
            </div>
