                ...
                <div className="flex w-full flex-col gap-8">
                    ...
                    <div className="flex w-full flex-col gap-8 rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-background-dark/50 md:p-8">
                        <div className="flex flex-col gap-2 text-center">
                            <p className="text-2xl font-black leading-tight tracking-[-0.033em] text-gray-900 dark:text-white md:text-3xl">Forgot Password?</p>
                        ...
                        {success ? (
                            <div className="flex flex-col gap-4">
                                <div className="px-4 py-3 rounded-md bg-green-50 text-green-600 text-sm border border-green-200">
